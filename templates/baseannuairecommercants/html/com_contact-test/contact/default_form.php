...
<div class="contact-form">
	<form id="contact-form" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-validate form-horizontal">
			...
			<div class="small" style="float:right">* Champ obligatoire</small></div>
			...
			<?php endforeach;?>
				...
				<button class="btn button validate" type="submit"><?php echo JText::_('COM_CONTACT_CONTACT_SEND'); ?></button>
